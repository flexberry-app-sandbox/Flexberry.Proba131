...
namespace IIS.Proba13
{
    ...
    public class ПланирСобес : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba13.РегистАнкеты fРегистАнкеты;
        ...
        [PropertyStorage(new string[] {
                "РегистАнкеты"})]
        [NotNull()]
        public virtual IIS.Proba13.РегистАнкеты РегистАнкеты
        {
            get
            {
                ...
                IIS.Proba13.РегистАнкеты result = this.fРегистАнкеты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланирСобесE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесE", typeof(IIS.Proba13.ПланирСобес));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланирСобесL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесL", typeof(IIS.Proba13.ПланирСобес));
                }
            }
        }
    }
