...
namespace IIS.Proba13
{
    ...
    public class РегистАнкеты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba13.ВакантДолжн fВакантДолжн;
        ...
        [PropertyStorage(new string[] {
                "ВакантДолжн"})]
        [NotNull()]
        public virtual IIS.Proba13.ВакантДолжн ВакантДолжн
        {
            get
            {
                ...
                IIS.Proba13.ВакантДолжн result = this.fВакантДолжн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыE", typeof(IIS.Proba13.РегистАнкеты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыL", typeof(IIS.Proba13.РегистАнкеты));
                }
            }
        }
    }
