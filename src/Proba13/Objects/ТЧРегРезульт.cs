...
namespace IIS.Proba13
{
    ...
    public class ТЧРегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba13.ИтогСобес fИтогСобес;
        
        private int fОценкаКандид;
        
        private string fКрКомИлиОбсРеш;
        
        private IIS.Proba13.РегРезульт fРегРезульт;
        ...
        public virtual IIS.Proba13.ИтогСобес ИтогСобес
        {
            get
            {
                ...
                IIS.Proba13.ИтогСобес result = this.fИтогСобес;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Proba13.РегРезульт.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РегРезульт"})]
        public virtual IIS.Proba13.РегРезульт РегРезульт
        {
            get
            {
                ...
                IIS.Proba13.РегРезульт result = this.fРегРезульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧРегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧРегРезультE", typeof(IIS.Proba13.ТЧРегРезульт));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧРегРезульт : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Proba13.DetailArrayOfТЧРегРезульт members)

        // *** End programmer edit section *** (IIS.Proba13.DetailArrayOfТЧРегРезульт members)
        ...
        /// </summary>
        public DetailArrayOfТЧРегРезульт(IIS.Proba13.РегРезульт fРегРезульт) : 
                base(typeof(ТЧРегРезульт), ((ICSSoft.STORMNET.DataObject)(fРегРезульт)))
        {
        }
        
        public IIS.Proba13.ТЧРегРезульт this[int index]
        {
            get
            {
                return ((IIS.Proba13.ТЧРегРезульт)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Proba13.ТЧРегРезульт dataobject)
        {
