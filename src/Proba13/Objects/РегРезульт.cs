...
namespace IIS.Proba13
{
    ...
    public class РегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba13.Организация fОрганизация;
        
        private IIS.Proba13.Сотрудники fСотрудники;
        
        private IIS.Proba13.ПланирСобес fПланирСобес;
        
        private IIS.Proba13.DetailArrayOfТЧРегРезульт fТЧРегРезульт;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Proba13.Организация Организация
        {
            get
            {
                ...
                IIS.Proba13.Организация result = this.fОрганизация;
        ...
        [PropertyStorage(new string[] {
                "ПланирСобес"})]
        [NotNull()]
        public virtual IIS.Proba13.ПланирСобес ПланирСобес
        {
            get
            {
                ...
                IIS.Proba13.ПланирСобес result = this.fПланирСобес;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.Proba13.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.Proba13.Сотрудники result = this.fСотрудники;
        ...
        public virtual IIS.Proba13.DetailArrayOfТЧРегРезульт ТЧРегРезульт
        {
            get
            {
                ...
                {
                    this.fТЧРегРезульт = new IIS.Proba13.DetailArrayOfТЧРегРезульт(this);
                }
                IIS.Proba13.DetailArrayOfТЧРегРезульт result = this.fТЧРегРезульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультE", typeof(IIS.Proba13.РегРезульт));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегРезультL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегРезультL", typeof(IIS.Proba13.РегРезульт));
                }
            }
        }
    }
